expenses = []
print()
print("--Miejsce do dodawania i przechowywania wydatków w danym miesiącu--")
...
def add_expense(month):
    ...
    expense_type = input("Podaj typ wydatku (rachunki, zakupy, paliwo, inny): ")
